...
class AtuinConfig extends \atuin\skeleton\config\AtuinConfig
{
    ...
    public function upMenu()
    {
        ...
        $this->menuItems->add_menu_item('apps_list', '@web/plugins/admin', 'apps_head', 'Intalled Apps', 'list-ul', NULL);
        $this->menuItems->add_menu_item('apps_new', '@web/apps/create', 'apps_head', 'Add New', 'plus', NULL);
